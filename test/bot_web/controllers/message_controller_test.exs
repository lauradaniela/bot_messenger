defmodule BotWeb.MessageControllerTest do
  use BotWeb.ConnCase

  alias Bot.Chats
  alias Bot.Chats.Message

  @create_attrs %{id_message: "some id_message", message: "some message"}
  ...
  describe "update message" do
    ...
    test "renders message when data is valid", %{conn: conn, message: %Message{id: id} = message} do
      ...
      assert json_response(conn, 200)["data"] == %{
        "id" => id,
        "id_message" => "some updated id_message",
